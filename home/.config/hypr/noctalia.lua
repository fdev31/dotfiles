...
local primary = "rgb(dbe467)"
local surface = "rgb(282a13)"
local on_surface = "rgb(f3f3f2)"
local secondary = "rgb(90d65c)"
local on_secondary = "rgb(242518)"
local error = "rgb(fd4663)"
local on_error = "rgb(242518)"
